...
1. This user interface system is designed **for testing purposes only**, with **the cataract identification task** provided as a representative test case. Here we provide a test prompt as an example: **realize the automated identification of cataracts using ocular images.** Enter the task in the command box and **click the “Send” button to start the task.**
...
🎯 **Click the button below to start testing AutoDS now:**
...
> No installation required. Launch and try it instantly.

---

## ⚠️ Notes

- **The system will automatically shut down after 1 hour of inactivity. Before the automatic termination, it will pop up reminders at 30 minutes countdown, 5 minutes countdown, and the time of ending.**
- **Do not refresh the page — this will clear your session and conversation history, the system will be restarted.**
- **For data security and patient privacy, uploading arbitrary datasets or downloading the dataset is not permitted.**
